...
const DocumentsPreviewPage: React.FC = () => {
  ...
  return (
    <div className={`bg-white/90 min-h-screen flex flex-col w-full`}>
      ...
      />
      <Header />
      <div className="flex mt-6 gap-4 font-manrope">
        {!isOpen && (
          <div className="fixed left-4 top-1/2 -translate-y-1/2 z-50">
            <ToolTip content="Open Panel">
              <Button
                onClick={() => setIsOpen(true)}
                className="bg-[#1D4ED8] text-white p-3 shadow-lg"
              >
        ...
        <div className="fixed bottom-5 right-5">
          <Button
            ...
            className="flex items-center gap-2 px-8 py-6 rounded-sm text-md bg-[#1D4ED8] hover:bg-[#1D4ED8]/90"
          >
