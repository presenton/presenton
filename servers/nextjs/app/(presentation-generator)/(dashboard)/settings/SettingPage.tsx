        ...
        <div className="custom_scrollbar min-h-0 w-full flex-1 overflow-y-auto pb-36 pr-5">
          <div className="sticky right-0 top-0 z-40 mb-4 bg-white/90 py-[28px] backdrop-blur">
            <div className="flex  gap-3 items-center ">
              ...
              <p className="text-[10px] px-2.5 py-0.5 rounded-[50px] text-[#2563EB] border border-[#EDEEEF]  font-medium ">
          ...
          {selectedProvider === "session" && (
            <div className="w-full max-w-lg space-y-5 rounded-[20px] border border-[#EDEEEF] bg-white p-7">
              ...
              <LogoutButton
                label="Sign out"
                className="inline-flex w-full items-center justify-center gap-2 rounded-[58px] border border-[#EDEEEF] bg-[#2563EB] px-5 py-3 font-syne text-xs font-semibold text-white transition hover:bg-[#6d46e6] disabled:cursor-not-allowed disabled:opacity-60"
              />
            </div>
          )}
        ...
        <div className="fixed bottom-20 right-5 z-50 mx-auto">
          <button
            ...
            className={`w-full font-syne font-semibold flex items-center justify-center gap-2 py-3 px-5 rounded-[58px] transition-all duration-500 ${buttonState.isDisabled
              ...
              : "bg-gradient-to-r from-blue-600 to-blue-600 hover:from-blue-700 hover:to-blue-700 focus:ring-4 focus:ring-blue-200"
              } text-white`}
          >
