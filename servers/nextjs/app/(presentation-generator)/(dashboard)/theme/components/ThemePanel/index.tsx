          ...
          {isFontUploading ? (
            <div className='flex items-center gap-3'>
              ...
              <div className='flex-1'>
                <p className='text-sm font-medium text-[#2563EB]'>Uploading font...</p>
                <p className='text-xs text-[#888]'>Please wait</p>
              </div>
            </div>
          ) : (
            <div className='flex items-center gap-3'>
              <div className='w-10 h-10 rounded-lg bg-[#DBEAFE] flex items-center justify-center group-hover:bg-[#DBEAFE] transition-colors'>
              ...
              <ChevronRight className='w-4 h-4 text-[#999] group-hover:text-[#2563EB] transition-colors' />
            </div>
          )}
        </div>
        <input
      ...
      >
        ...
        <div className="border-2 border-dashed  border-gray-300 rounded-lg p-6 text-center">
          {isLogoUploading ? (
            ...
            <>
              <div className='w-[42px] h-[42px] mx-auto flex justify-center items-center rounded-full bg-[#DBEAFE]' >
