  ...
  return (
    <div className="w-full border-y border-[#EDEEEF]">
      <Link
        ...
        className="group mx-auto flex h-[250px] w-full max-w-[577px] flex-col items-center justify-center gap-[14px] border-x border-[#EDEEEF] bg-white px-5 outline-none transition-colors hover:bg-[#FDFDFF] focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#2563EB]"
        onClick={() =>
      ...
      >
        ...
        <span className="flex flex-wrap items-center justify-center gap-x-1.5 text-center font-syne text-sm font-medium">
          ...
          <span className="text-[#2563EB]">Get started now</span>
        </span>
      </Link>
    </div>
  );
