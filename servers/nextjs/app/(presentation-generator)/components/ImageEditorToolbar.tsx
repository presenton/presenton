  ...
  return (
    <div className="inline-flex items-center gap-3 rounded-[6px] bg-white px-[10px] py-[6px] shadow-[0_0_4px_rgba(0,0,0,0.15)]">
          ...
          {FIT_OPTIONS.map((option) => (
            <DropdownMenuItem
              ...
              className={cn(
                ...
                objectFit === option.value && "bg-[#EFF6FF] text-[#7C3AED]",
              )}
            >
              {option.label}
            </DropdownMenuItem>
      ...
      <div className="inline-flex items-center gap-3">
        <button
          ...
          className={cn(
            ...
            objectFit === "cover" && "bg-[#EFF6FF] text-[#7C3AED]",
          )}
        >
        ...
        <button
          ...
          className={cn(
            "rounded-[2px] p-1 text-[#191919] hover:bg-[#F8F8FA]",
            objectFit === "contain" && "bg-[#EFF6FF] text-[#7C3AED]",
          )}
        >
        ...
        <button
          ...
          className={cn(
            "rounded-[2px] p-1 text-[#191919] hover:bg-[#F8F8FA]",
            objectFit === "fill" && "bg-[#EFF6FF] text-[#7C3AED]",
          )}
        >
      ...
      <button
        ...
        className={cn(
          "rounded-[2px] p-1 text-[#191919] hover:bg-[#F8F8FA]",
          isFocusPointMode && "bg-[#EFF6FF] text-[#7C3AED]",
        )}
      >
