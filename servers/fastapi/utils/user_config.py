...
def get_user_config():
    ...
    return UserConfig(
        ...
        AZURE_OPENAI_API_KEY=existing_config.AZURE_OPENAI_API_KEY or get_azure_openai_api_key_env(),
        AZURE_OPENAI_MODEL=existing_config.AZURE_OPENAI_MODEL or get_azure_openai_model_env(),
        ...
        BEDROCK_PROFILE_NAME=existing_config.BEDROCK_PROFILE_NAME or get_bedrock_profile_name_env(),
        ...
        FIREWORKS_BASE_URL=existing_config.FIREWORKS_BASE_URL or get_fireworks_base_url_env(),
        ...
        ANTHROPIC_API_KEY=existing_config.ANTHROPIC_API_KEY or get_anthropic_api_key_env(),
        ...
        CUSTOM_LLM_API_KEY=existing_config.CUSTOM_LLM_API_KEY or get_custom_llm_api_key_env(),
        ...
        LLM_REASONING_MODE=existing_config.LLM_REASONING_MODE or get_llm_reasoning_mode_env(),
        LLM_REASONING_EFFORT=existing_config.LLM_REASONING_EFFORT or get_llm_reasoning_effort_env(),
        ...
        WEB_SEARCH_PROVIDER=existing_config.WEB_SEARCH_PROVIDER or get_web_search_provider_env(),
        ...
        BRAVE_SEARCH_API_KEY=existing_config.BRAVE_SEARCH_API_KEY or get_brave_search_api_key_env(),
        ...
        OPEN_WEBUI_IMAGE_API_KEY=existing_config.OPEN_WEBUI_IMAGE_API_KEY
        or get_open_webui_image_api_key_env(),
...
def update_env_with_user_config():
    ...
    if user_config.LLM_REASONING_BUDGET_TOKENS is not None:
        set_llm_reasoning_budget_tokens_env(str(user_config.LLM_REASONING_BUDGET_TOKENS))
