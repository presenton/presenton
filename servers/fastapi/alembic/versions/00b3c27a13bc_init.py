...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_presentation_layout_codes_presentation"),
        "presentation_layout_codes",
        ["presentation"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_webhook_subscriptions_event"), "webhook_subscriptions", ["event"], unique=False
    )
    op.create_table(
        "slides",
        sa.Column("id", sa.Uuid(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_presentation_layout_codes_presentation"), table_name="presentation_layout_codes"
    )
